...
export default function ResumeInteractive() {
  ...
  const professionalSummary = {
    summary:
      'Full-Stack Software Engineer trained at Moringa School with strong hands-on experience building modern web applications using React, Flask, and PostgreSQL. Passionate about clean architecture, RESTful APIs, and user-centered design. Experienced in delivering end-to-end projects including authentication, dashboards, and data-driven systems.',
    highlights: [
  ...
  const featuredProjects: Project[] = [
    {
      ...
      description:
        'A full-stack food ordering platform where customers browse menus, place orders, and restaurant owners manage menus and orders.',
    ...
    },
    {
      ...
      description:
        'A research-focused platform for managing livestock and fish disease data including symptoms, treatments, and prevention.',
      role: 'Full-Stack Developer',
      impact:
    ...
    },
    {
      ...
      title: 'SalesPilot',
      description:
        'A sales management dashboard for tracking customers, products, and performance metrics.',
      role: 'Full-Stack Developer',
      impact:
